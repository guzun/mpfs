...
class widget_category_icons extends WP_Widget {
	...
	/*Constructor*/
		$widget_ops = array( 'classname' => 'widget_category_icons ', 'description' => __( 'Category with representative icons' , 'twentyfourteen' ) );
		$this->WP_Widget( 'widget_cosmo_category_icons', __( 'MPFS Category icons' , 'twentyfourteen' ) , $widget_ops );
	}
	...
	/*widgetform in backend*/
        ...
        ?>
            <p>
                <label for="<?php echo $this -> get_field_id( 'title' ); ?>"><?php _e( 'Title' , 'twentyfourteen' ) ?>:
